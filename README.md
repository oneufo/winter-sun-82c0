...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/winter-sun-82c0)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/winter-sun-82c0
```

A live public deployment of this template is available at [https://winter-sun-82c0.templates.workers.dev](https://winter-sun-82c0.templates.workers.dev)
